...
| 3 | **CHARR contamination screen (VCF-only freemix).** | High | Low | 1–3% contamination turns hom-ref→apparent-het, manufacturing false inherited hets / comp-het second hits. Computable from AD/DP/GQ already parsed; no BAM needed. |
